...
Revision ID: 2e64e9d5feef
Revises: 
Create Date: 2024-11-09 13:22:38.013318
...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['followed_id'], ['user.id'], name='follows_ibfk_1'),
    sa.ForeignKeyConstraint(['follower_id'], ['user.id'], name='follows_ibfk_2'),
